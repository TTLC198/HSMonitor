...
public class ApplicationSettings
{
    ...
    [JsonPropertyName("SerialPort")] public string? LastSelectedPort { get; set; }

    [JsonPropertyName("BaudRate")] public int LastSelectedBaudRate { get; set; }
    ...
    // Advanced
    [JsonIgnore] public bool IsAutoStartEnabled { get; set; }
