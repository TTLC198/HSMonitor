...
public class AppearanceSettingsTabViewModel : SettingsTabBaseViewModel
{
    ...
    {
        get => IsAutoDetectHardwareEnabled
            ? (_hardwareMonitorService.Cpu.Type ?? SettingsService.Settings.CpuCustomType ?? "Unknown")
            .SplitByCapitalLettersConvention().First()
            : SettingsService.Settings.CpuCustomType;
    ...
    {
        get => IsAutoDetectHardwareEnabled
            ? (_hardwareMonitorService.Gpu.Type ?? SettingsService.Settings.GpuCustomType ?? "Unknown")
            .SplitByCapitalLettersConvention().First()
            : SettingsService.Settings.GpuCustomType;
    ...
    {
        get => IsAutoDetectHardwareEnabled
            ? (_hardwareMonitorService.Memory.Type ?? SettingsService.Settings.MemoryCustomType ?? "Unknown")
            .SplitByCapitalLettersConvention().First()
            : SettingsService.Settings.MemoryCustomType;
    ...
    public bool IsAutoDetectHardwareEnabled
    {
        ...
        set
        {
            if (!value)
            {
                ...
                SettingsService.Settings.CpuCustomType =
                    (_hardwareMonitorService.Cpu.Type ?? CpuCustomType ?? "Unknown").SplitByCapitalLettersConvention()
                    .First();
                SettingsService.Settings.GpuCustomType =
                    (_hardwareMonitorService.Gpu.Type ?? GpuCustomType ?? "Unknown").SplitByCapitalLettersConvention()
                    .First();
                SettingsService.Settings.MemoryCustomType =
                    (_hardwareMonitorService.Memory.Type ?? MemoryCustomType ?? "Unknown")
                    .SplitByCapitalLettersConvention().First();
                ;
            }
