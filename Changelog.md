...
- Реализована возможность автоматической установки PawnIO для получения расширенной информации о CPU,
- Устранены ошибки при первом запуске программы,
- Улучшена стабильность системы.

### v1.2.0 (23.02.2026)

- Добавлена возможность обновления прошивки устройства через программу,
- Окно настроек перенесено вправо вбок для улучшения опыта взаимодействия с интерфейсом программы,
- Улучшена работа со всплывающими окнами программы,
- Проведена оптимизация и рефакторинг программы.
